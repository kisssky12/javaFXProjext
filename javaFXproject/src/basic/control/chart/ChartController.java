...
public class ChartController implements Initializable {
   ...
   public void initialize(URL arg0, ResourceBundle arg1) {
      ObservableList<Data> list = FXCollections.observableArrayList(
            ...
            new PieChart.Data("SWT", 25), new PieChart.Data("JavaFX", 35)); //이렇게도 추가 가능
//      이렇게도 추가 가능      
...
//      areaChart.getData().add(s4);
   ...
   public ObservableList<XYChart.Data<String, Integer>> getSeries4() {
      ...
      list.add(new XYChart.Data<String, Integer>("09", 32));
      list.add(new XYChart.Data<String, Integer>("10", 24));
      list.add(new XYChart.Data<String, Integer>("11", 28));
      list.add(new XYChart.Data<String, Integer>("12", 12));
      return list;
   }
}